...
/**
 * Helper for mod_ipheiongeojsons
 */

abstract class ModIpheionGeojsonsHelper
{
    /**
     * The class ModIpheionGeojsonsHelper gets a list of all installed extensions of this Joomla! website
     *
     **/
